...
public class CreditIP {
    ...
    public CreditIP(String bankName, String collateral, byte[] image, double monthFee, double percent, double sumCredit, double term, double timeFee, String type) {
